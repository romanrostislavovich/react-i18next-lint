...
class Cli {
    ...
    public  async runLint(
        ...
        fetchSettings?: IFetch
            ...
            const validationModel: NgxTranslateLint = new NgxTranslateLint(project, languages, ignore, errorConfig, fixZombiesKeys, fetchSettings, i18nextRegExp.reactI18Next);
